...
本项目提供了一个基于 [Karabiner-Elements](https://karabiner-elements.pqrs.org/) 的极简、稳定且零污染的解决方案。
...
你可以用文本编辑器打开 JSON 文件，搜索 `hold_down_milliseconds": 50`，批量将 `30` 修改为 `50` 或 `70` 即可。如果你觉得打字有轻微卡顿感，也可以将其批量调低为 `20`。
